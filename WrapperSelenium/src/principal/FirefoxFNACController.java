...
public class FirefoxFNACController {
	...
	public FirefoxFNACController(String elemento_a_buscar) {
		...
		if (desplegable_elementos_pagina != null) {
			...
			System.out.println("Pulsando sobre el desplegable de elementos por página");
		}

		//Espero a la opción de 100 elementos por página
		...
		if (opcion_100_elementos != null) {
			...
			System.out.println("Pulsando la opción de 100 elementos por página");			
		}
		try {
			Thread.sleep(5000);
		} 
